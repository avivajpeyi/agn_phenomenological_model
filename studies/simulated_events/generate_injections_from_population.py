...
def generate_prior(p):
    ...
    p_costheta12 = truncnorm(xx=cos_vals, mu=1, sigma=p['sigma_12_list'], high=1, low=-1)
    p_costilt1 = truncnorm(xx=cos_vals, mu=1, sigma=p['sigma_1_list'], high=1, low=-1)
...
def generate_agn_spins(theta_12, phi_12, theta_1, phi_1):
    ...
    Here S1 is defined wrt pred_z, and S2* is defined wrt S1_z.
