...
def plot_overlaid_corners(sigma_1_list, sigma_12_list, pltdir, n=NUM,
    ...
    isotropic_samples = get_samples_from_prior(num_samples=n,prior_fname="isotropic.prior")
...
def plot_one_corner(sigma_1=0.01, sigma_12=0.01):
    n = 10000
    plot_overlaid_corners([0],[0], pltdir=".", n=n, show_aligned=True, show_agn=False)
    plot_overlaid_corners([100], [100], pltdir=".", n=n, show_isotropic=True, show_agn=False)


def gif_main():
    sigma12_vals = list(np.arange(0.3, 3, 0.3))
    sigma1_vals = [0.1 for _ in range(len(sigma12_vals))]
